...
the Product table in the AW1 database. Additionally, 
...
USE AW2;
GO
SELECT top 5000 p.Name AS ProductName, 
...
USE AW2;
GO
SELECT top 10000 'Total income is', ((OrderQty * UnitPrice) * (1.0 - UnitPriceDiscount)), ' for ',
...
GO
ALTER DATABASE AW1 SET RECOVERY BULK_LOGGED;
GO
...
AND ListPrice < $10000;
GO
ALTER DATABASE AW1 SET RECOVERY FULL;
GO
...
USE AW2;
GO
SELECT  top 5000  pp.LastName, pp.FirstName 
FROM Person.Person pp JOIN HumanResources.Employee e
ON e.BusinessEntityID = pp.BusinessEntityID WHERE pp.BusinessEntityID IN 
(SELECT top 5000 SalesPersonID 
FROM Sales.SalesOrderHeader
...
FROM 
(
SELECT TOP 1000000 SalesOrderDetailID, OrderQty, UnitPrice
from Sales.SalesOrderDetail
where orderqty>9
) a
...
USE AW2;
GO
SELECT top 1000000 ProductID, OrderQty, LineTotal
FROM Sales.SalesOrderDetail
